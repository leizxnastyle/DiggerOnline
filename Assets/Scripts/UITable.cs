...
public class UITable : MonoBehaviour
{
	...
	public static int SortByTagName(Transform a, Transform b)
	{
	...
	public List<Transform> children
	{
		get
		{
			if (this.mChildren.Count == 0)
			{
				...
				if (this.sorted)
				{
					this.mChildren.Sort(new Comparison<Transform>(UITable.SortByTagName));
				}
				if (this.reverse)
				{
					this.mChildren.Reverse();
				}
			}
