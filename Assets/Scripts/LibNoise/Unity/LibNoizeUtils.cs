...
{
	internal static class LibNoizeUtils
	{
		internal static double GradientCoherentNoise3D(double x, double y, double z, long seed, QualityMode quality)
		{
			...
			case QualityMode.Medium:
				position = LibNoizeUtils.MapCubicSCurve(x - (double)num);
				position2 = LibNoizeUtils.MapCubicSCurve(y - (double)num2);
				position3 = LibNoizeUtils.MapCubicSCurve(z - (double)num3);
				break;
			case QualityMode.High:
				position = LibNoizeUtils.MapQuinticSCurve(x - (double)num);
				position2 = LibNoizeUtils.MapQuinticSCurve(y - (double)num2);
				position3 = LibNoizeUtils.MapQuinticSCurve(z - (double)num3);
				break;
			}
			double a = LibNoizeUtils.GradientNoise3D(x, y, z, num, num2, num3, seed);
			double b = LibNoizeUtils.GradientNoise3D(x, y, z, ix, num2, num3, seed);
			double a2 = LibNoizeUtils.InterpolateLinear(a, b, position);
			a = LibNoizeUtils.GradientNoise3D(x, y, z, num, iy, num3, seed);
			b = LibNoizeUtils.GradientNoise3D(x, y, z, ix, iy, num3, seed);
			double b2 = LibNoizeUtils.InterpolateLinear(a, b, position);
			double a3 = LibNoizeUtils.InterpolateLinear(a2, b2, position2);
			a = LibNoizeUtils.GradientNoise3D(x, y, z, num, num2, iz, seed);
			b = LibNoizeUtils.GradientNoise3D(x, y, z, ix, num2, iz, seed);
			a2 = LibNoizeUtils.InterpolateLinear(a, b, position);
			a = LibNoizeUtils.GradientNoise3D(x, y, z, num, iy, iz, seed);
			b = LibNoizeUtils.GradientNoise3D(x, y, z, ix, iy, iz, seed);
			b2 = LibNoizeUtils.InterpolateLinear(a, b, position);
			double b3 = LibNoizeUtils.InterpolateLinear(a2, b2, position2);
			return LibNoizeUtils.InterpolateLinear(a3, b3, position3);
		}
		...
		internal static double GradientNoise3D(double fx, double fy, double fz, int ix, int iy, int iz, long seed)
		{
			...
			checked
			{
				num2 = LibNoizeUtils._randoms[(int)((IntPtr)(num << 2))];
				num3 = LibNoizeUtils._randoms[(int)((IntPtr)(unchecked((num << 2) + 1L)))];
				num4 = LibNoizeUtils._randoms[(int)((IntPtr)(unchecked((num << 2) + 2L)))];
			}
		...
		{
			return 1.0 - (double)LibNoizeUtils.ValueNoise3DInt(x, y, z, seed) / 1073741824.0;
		}
