...
public class UICamera : MonoBehaviour
{
		...
		set
		{
			if (UICamera.mSel != value)
			{
				...
				if (UICamera.mSel != null)
				{
					...
					{
						UnityEngine.Debug.Log("The fuck? " + UICamera.mList.Count);
					}
				}
			}
		}
	...
	private void FixedUpdate()
	{
		...
		{
			UICamera.hoveredObject = ((!UICamera.Raycast(UnityEngine.Input.mousePosition, ref UICamera.lastHit)) ? UICamera.fallThrough : UICamera.lastHit.collider.gameObject);
