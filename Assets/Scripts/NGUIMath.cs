...
public static class NGUIMath
{
	...
	public static Vector3 ApplyHalfPixelOffset(Vector3 pos)
	{
		...
		if (platform == RuntimePlatform.WindowsPlayer || platform == RuntimePlatform.WebGLPlayer || platform == RuntimePlatform.WindowsEditor || platform == RuntimePlatform.XBOX360)
		{
			pos.x -= 0.5f;
			pos.y += 0.5f;
		}
