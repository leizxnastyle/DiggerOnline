...
namespace ExitGames.Client.Photon.Chat
{
	public class ChatClient : IPhotonPeerListener
	{
		...
		public bool PublishMessage(string channelName, object message)
		{
			...
			return this.chatPeer.OpCustom(2, customOpParameters, true);
		}
		...
		public bool SendPrivateMessage(string target, object message, bool encrypt)
		{
			...
			return this.chatPeer.OpCustom(3, customOpParameters, true, 0, encrypt);
		}
		...
		{
			foreach (string key in (string[])eventData[0])
			{
